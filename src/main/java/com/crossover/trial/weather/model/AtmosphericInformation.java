...
/**
 * <h1>Atmospheric Information</h1>
 * 
 * <p>This object is used to store weather information for a particular airport.
 * It stores a set of five distinct data readings (5 {@ link DataPoint} objects) that records
 * different weather parameters. ({@ link DataPointType} )
 * It also records the latest update information in milliseconds.
 * </p>
 * @author deedsing
 *
 */
